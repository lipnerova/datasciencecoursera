...
* Requires
  ...
  * A merging approach
* Produces
  * A tree showing how close things are to each other => the number of clusters is set by the 'cut' position in the tree
...
## Hierarchical clustering - `dist` to calculate distances in a dataframe
...
rdistxy
diag(rdistxy) <- diag(rdistxy) + 1e5 #adding a very large value to the 0 diag, so the following which works 
rdistxy
...
# Find the index of the new points with minimum distance
