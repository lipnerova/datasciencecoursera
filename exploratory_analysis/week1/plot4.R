...
# 1,2
plot  (workingData$cleanTime, workingData$Voltage, type='l', xlab = '', ylab = 'Voltage')
...
# 2,2
plot  (workingData$cleanTime, workingData$Global_reactive_power, type='l', xlab = '', ylab = 'Global Reactive Power (kilowatts)')
