...
```{r, echo=FALSE, fig.width=11, cache=TRUE}
# fatalities
...
```{r, echo=FALSE}
# fatalities
stormSelectFilter[which(stormSelectFilter$FATALITIES > 200), 
...
```{r, echo=FALSE}
# Injuries
stormSelectFilter[which(stormSelectFilter$INJURIES > 1000), 
...
```{r, echo=FALSE}
# property damage
stormSelectFilter[which(stormSelectFilter$prop_dmg >= 10*10^9), 
...
# crop damage
stormSelectFilter[which(stormSelectFilter$crop_dmg >= 10^9), 
...
select(stormPropDmgFinal, -c(prop_dmg,avg))
```
...
select(stormCropDmgFinal, -c(crop_dmg,avg))
```
