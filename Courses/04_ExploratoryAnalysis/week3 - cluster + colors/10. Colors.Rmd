...
- There are 3 types of palettes
  - Sequential:  data ordered from low to high
  - Diverging:   deviation from a mean, etc.
  - Qualitative: categories, etc. (non ordered data)
...
plot (x, y, pch=19, col=rgb(0,0,0,0.07))
